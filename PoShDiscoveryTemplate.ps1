...
.DESCRIPTION
    The PoSh Discovery Report template automates the process of gathering information by generating standardized text reports in various environments.
    Create snippets with ChatGPT by using this template to streamline information gathering and produce repeatable reports.
.KEY FEATURES
